    ...
    <RACDateInput
      ...
      className={(renderProps) => {
        return twMerge(
          ...
          '[[role=presentation]_&.border]:h-fit [[role=presentation]_&.border]:border-none [[role=presentation]_&.border]:pe-0 [[role=presentation]_&.border]:shadow-none [[role=presentation]_&.border]:ring-0',
          '[[role=group]_&.border]:h-fit [[role=group]_&.border]:border-none [[role=group]_&.border]:pe-0 [[role=group]_&.border]:shadow-none [[role=group]_&.border]:ring-0 [[role=group]_&.border]:invalid:ring-0',
          className,
        );
      }}
    >
