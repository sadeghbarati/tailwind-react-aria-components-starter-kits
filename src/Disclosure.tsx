...
export function DisclosureControl({
  ...
  return (
    <summary
      {...props}
      className={twMerge(
        'flex w-full cursor-pointer select-none justify-between rounded text-start text-base/6 font-medium outline-none group-open:mb-2 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 focus-visible:ring-offset-background [&::-webkit-details-marker]:hidden',
        className,
      )}
    />
  );
