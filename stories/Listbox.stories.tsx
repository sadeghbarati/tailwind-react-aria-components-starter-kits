    ...
    <div className="flex flex-col items-center gap-1">
      <div className="flex rounded-xl border-2 border-transparent p-0.5 group-selected:border-accent">
        <div className="flex w-32">
          <div className="flex flex-1 flex-col gap-2 overflow-hidden rounded-l-lg border-b border-s border-t bg-white ps-2 pt-4">
            <div className="h-6 rounded-l-sm border border-zinc-200 bg-zinc-100 p-1.5">
              <div className="h-full rounded-sm bg-accent"></div>
            </div>

            <div className="ms-auto flex h-8 w-3/4 flex-1 rounded-tl-md border-s border-t border-zinc-200 bg-zinc-100 shadow-sm">
          ...
          <div className="flex flex-1 flex-col gap-2 overflow-hidden rounded-r-lg border-b border-e border-t border-zinc-900 bg-zinc-900 ps-2 pt-4 dark:border-b-border dark:border-e-border dark:border-t-border">
            ...
            <div className="ms-auto flex h-8 w-3/4 flex-1 rounded-tl-md border-s border-t border-zinc-800 bg-zinc-800 shadow-sm">
              <div className="flex h-8 gap-1 p-1.5">
                <span className="h-1.5 w-1.5 rounded-full bg-orange-400"></span>
                <span className="h-1.5 w-1.5 rounded-full bg-amber-400"></span>
                <span className="h-1.5 w-1.5 rounded-full bg-green-400"></span>
